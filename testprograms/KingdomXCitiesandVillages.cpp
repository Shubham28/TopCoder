...
double KingdomXCitiesandVillages::determineLength(vector <int> cix, vector <int> ciy, vector <int> vix, vector <int> viy) {
}
...
bool KawigiEdit_RunTest(int testNum, vector <int> p0, vector <int> p1, vector <int> p2, vector <int> p3, bool hasAnswer, double p4) {
	...
	double answer;
	obj = new KingdomXCitiesandVillages();
